...
const tiers = [
  {
    ...
    featured: false,
    rows: [
      { product: "Complete set", half: "$80", full: "$100", note: "Kite, bar, board, harness" },
      { product: "Kite and bar", half: "$60", full: "$80", note: "Bring your own board" },
  ...
  },
  {
    ...
    desc: "Latest models, premium brands. 20 percent upgrade over Standard.",
    featured: true,
    rows: [
      { product: "Complete set", half: "$95", full: "$120", note: "Kite, bar, board, harness" },
      { product: "Kite and bar", half: "$70", full: "$95", note: "Bring your own board" },
      { product: "Board only", half: "$30", full: "$50", note: "Twintip or directional" },
    ],
  },
  {
    name: "Foil",
