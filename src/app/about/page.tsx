    ...
    <div style={{ background: SAND }} className="min-h-screen">
      ...
      <section className="relative flex items-end justify-start overflow-hidden" style={{ minHeight: "70vh" }}>
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, rgba(0,0,0,0.05) 0%, rgba(0,0,0,0.05) 25%, rgba(7,17,31,0.65) 55%, rgba(7,17,31,0.93) 80%, rgba(7,17,31,1) 100%)",
          }}
        />
        <div className="relative z-10 w-full px-8 sm:px-14 lg:px-20 pb-16 md:pb-24">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.h1
              variants={fadeUp}
              className="font-black text-white uppercase tracking-tighter mb-6 text-[clamp(52px,9vw,120px)] leading-[0.88]"
            >
              The<br />Blue Bus
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="font-body uppercase tracking-widest text-[12px] mb-10 max-w-[500px]"
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/lessons"
                className="font-display font-black uppercase tracking-widest px-8 py-4 text-[11px] rounded-none"
                style={{ background: CYAN, color: "#fff", border: "none" }}
              >
                Book a Lesson
              </Link>
              <a
                href="https://wa.me/5997015483"
                target="_blank"
      ...
      <section className="py-20 md:py-28" style={{ background: OCEAN_DEEP }}>
        <div className="max-w-7xl mx-auto px-8 sm:px-14 lg:px-20">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <motion.h2
              variants={fadeUp}
              className="font-black text-white uppercase tracking-tighter mb-12 text-[clamp(32px,4.5vw,60px)] leading-[0.88]"
            >
              Kiteboarding is not<br />our job. It's our life.
            </motion.h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
              <motion.div variants={fadeUp}>
                <p className="font-body text-[15px] leading-[1.7] text-white/85 mb-6">
                  We live for the ocean, the wind, nature, and the freedom that comes from being on the water. Kiteboarding is a lifestyle. It's a call that transforms people, some come for the adventure in their holiday, others answer the call of their soul.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-white/75">
                  We've seen people change for the better through the elements, through the freedom, through the sport. It touches every part of your life. That transformation is what we're part of, and that's why we do this.
                </p>
              </motion.div>

              <motion.div variants={fadeUp}>
                <p className="font-body text-[15px] leading-[1.7] text-white/85 mb-6">
                  KBB isn't the bus or the infrastructure. KBB is Atlantis. KBB is Bonaire. KBB is the locals who've been building this spot for years, and the visitors who fall in love with it and become part of the family.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-white/75">
                  We believe in bringing joy, happiness, and the freedom of the water to as many people as we can. We grow the sport, we grow the community, we grow the KBB family. We're all in this together, since the beginning.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-14 lg:px-20">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start mb-16">
              <motion.div variants={fadeUp}>
                <p className="font-display font-black uppercase tracking-widest text-[12px] mb-6" style={{ color: CYAN }}>
                  Our History
                </p>
                <h2
                  className="font-black uppercase tracking-tighter text-[clamp(32px,4.5vw,60px)] leading-[0.88]"
                  style={{ color: INK }}
                >
                  25 Years on<br />the Same Beach
                </h2>
              </motion.div>

              <motion.div variants={fadeUp}>
                <p className="font-body text-[15px] leading-[1.7] text-[rgba(0,0,0,0.75)] mb-6">
                  Roan Jaspers put the first kite in the air on Atlantis Beach in 2001. Nobody had done it before in the Caribbean. In 2016, Rommel took the keys. Not as a businessman, but as a rider who had been part of this community and couldn't imagine it going anywhere else.
                </p>
                <p className="font-body text-[15px] leading-[1.7] text-[rgba(0,0,0,0.7)]">
                  What hasn't changed in 25 years is why people show up. The wind. The water. The feeling when Atlantis Beach comes into view and the kites are already in the air.
                </p>
              </motion.div>
            </div>
            ...
            <motion.div variants={fadeUp} className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 border-t-2" style={{ borderColor: INK }}>
              {[
                ...
                <div key={s.num}>
                  ...
                  <p className="font-display font-black text-[11px] uppercase tracking-widest" style={{ color: "rgba(0,0,0,0.5)" }}>
                    {s.label}
                  </p>
                </div>
              ))}
      ...
      <section className="py-20 md:py-28" style={{ background: SAND }}>
        <div className="max-w-7xl mx-auto px-8 sm:px-14 lg:px-20">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              {people.map((person) => (
                <div
                  ...
                  style={{ boxShadow: "0 1px 4px rgba(0,0,0,0.06), 0 0 0 0.5px rgba(0,0,0,0.05)" }}
                >
                  ...
                  <div
                    ...
                    style={{ background: person.dark ? OCEAN_DEEP : "#fff" }}
                  >
                    <p className="font-display font-black uppercase tracking-widest text-[12px] mb-4" style={{ color: CYAN }}>
                      {person.role}
                    </p>
                    <h3
                      className="font-black uppercase tracking-tighter mb-4 text-[clamp(24px,3vw,36px)] leading-[0.88]"
                      style={{ color: person.dark ? "#fff" : INK }}
                    >
                      {person.name}
                    </h3>
                    <p
                      className="font-body text-[15px] leading-[1.6]"
                      style={{ color: person.dark ? "rgba(255,255,255,0.75)" : "rgba(0,0,0,0.75)" }}
                    >
                      {person.bio}
                    </p>
                  </div>
            ...
            <motion.div
              variants={fadeUp}
              className="overflow-hidden rounded-[12px] mb-16"
              style={{ height: "clamp(200px, 25vw, 380px)", boxShadow: "0 1px 4px rgba(0,0,0,0.06), 0 0 0 0.5px rgba(0,0,0,0.05)" }}
            >
            ...
            <motion.div variants={fadeUp}>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20 items-start mb-12">
                <div className="md:col-span-5">
                  ...
                  <h3
                    className="font-black uppercase tracking-tighter text-[clamp(28px,3.5vw,48px)] leading-[0.88]"
                    style={{ color: INK }}
                  >
                    The Instructors
                  </h3>
                ...
                {instructors.map((instructor, i) => (
                  ...
                  >
                    ...
                    <div className="px-4 py-3 bg-white">
                      <p className="font-display font-black text-[11px] uppercase tracking-widest" style={{ color: "rgba(0,0,0,0.65)" }}>
                        {instructor.name}
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-20 md:py-28 text-center" style={{ background: OCEAN }}>
        <div className="max-w-3xl mx-auto px-8 sm:px-14 lg:px-20">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <motion.p
              variants={fadeUp}
              className="text-white/75 font-body text-[15px] uppercase tracking-widest mb-10"
            >
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/5997015483?text=Hi!%20I'd%20like%20to%20know%20more%20about%20Kiteboarding%20Bonaire"
                target="_blank"
                rel="noopener noreferrer"
                className="font-display font-black uppercase tracking-widest px-8 py-4 text-[11px] rounded-none"
                style={{ background: "transparent", color: "#fff", border: `2px solid ${CYAN}` }}
