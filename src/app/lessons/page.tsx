...
const PACKAGES: Record<string, Pkg[]> = {
  "beginner-solo": [
    ...
    { name: "Block of 3",   sessions: "1×3h + 2×2h",        price: "\$820", outcome: "IKO Level 2",            badge: "Most Popular", featured: true, vikingId: "370000001f000000c4c250e2", detail: "Waterstart. First rides. The moment you actually feel it click.", photo: photoInstructionWater.src, photoPosition: "object-center" },
    { name: "Block of 5",   sessions: "1×3h + 4×2h",        price: "\$1,210", outcome: "Toward IKO Level 3", vikingId: "3700000029000000b9651037", detail: "Board starts, upwind, speed control. Ride independently anywhere in the world.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
  "beginner-duo": [
    ...
    { name: "Block of 3",   sessions: "1×3h + 2×2h",        price: "\$1,100",   perPerson: "\$475 per person", outcome: "IKO Level 2",   badge: "Best Value", featured: true, vikingId: "3700000028000000dc02ac8f", detail: "Waterstart by session three. Shared kite, shared stoke, same result.", photo: photoInstructionWater.src, photoPosition: "object-center" },
    { name: "Block of 5",   sessions: "1×3h + 4×2h",        price: "\$1,600", perPerson: "\$770 per person", outcome: "Toward IKO Level 3", vikingId: "3700000020000000332a184a", detail: "Zero to riding for both of you. Board starts, upwind, independent.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
  "intermediate-solo": [
    { name: "Single Session", sessions: "1 session · 2 hours", price: "\$290",   outcome: "Goal-based",    vikingId: "3700000007000000b4bdfd77", detail: "Two hours on what you actually want to fix. Jumps, transitions, upwind. You set it.", photo: lessonAction.src, photoPosition: "object-center" },
    { name: "Block of 3",     sessions: "3 × 2 hours",         price: "\$820",   outcome: "IKO Level 4 to 5", badge: "Most Popular", featured: true, vikingId: "3700000002000000864d2340", detail: "Goals set before session one. Progress reviewed after each. Real coaching, real results.", photo: photoInstructionWater.src, photoPosition: "object-center" },
    { name: "Block of 5",     sessions: "5 × 2 hours",         price: "\$1,210", outcome: "IKO Level 5",   vikingId: "3700000007000000b4bdfd77", detail: "Five sessions. Enough to genuinely transform your riding in Bonaire's trade winds.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
  "intermediate-duo": [
    { name: "Single Session", sessions: "1 session · 3 hours", price: "\$360",   perPerson: "\$180 per person", outcome: "Goal-based",    vikingId: "37000000050000003f75f4dd", detail: "Three hours for both of you. Best when you're at a similar level.", photo: lessonBeach.src, photoPosition: "object-center" },
    { name: "Block of 3",     sessions: "3 × 2 hours",         price: "\$1,100",   perPerson: "\$550 per person", outcome: "IKO Level 4 to 5", badge: "Best Value", featured: true, vikingId: "g370000000f0000005b9549b2", detail: "You learn as much watching your partner as you do on the kite.", photo: photoInstructionWater.src, photoPosition: "object-center" },
    { name: "Block of 5",     sessions: "5 × 2 hours",         price: "\$1,600", perPerson: "\$800 per person", outcome: "IKO Level 5",   vikingId: "370000001000000092d233ba", detail: "Five sessions. Real transformation for two, not just marginal gains.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
};
