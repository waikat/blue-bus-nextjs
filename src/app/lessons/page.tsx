...
const PACKAGES: Record<string, Pkg[]> = {
  "beginner-solo": [
    ...
    { name: "Block of 5",   sessions: "1×3h + 4×2h",        price: "\$990", outcome: "Toward IKO Level 3", vikingId: "3700000029000000b9651037", detail: "Board starts, upwind, speed control. Ride independently anywhere in the world.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
  "beginner-duo": [
    ...
    { name: "Block of 3",   sessions: "1×3h + 2×2h",        price: "\$860",   perPerson: "\$430 per person", outcome: "IKO Level 2",   badge: "Best Value", featured: true, vikingId: "3700000028000000dc02ac8f", detail: "Waterstart by session three. Shared kite, shared stoke, same result.", photo: photoInstructionWater.src, photoPosition: "object-center" },
    { name: "Block of 5",   sessions: "1×3h + 4×2h",        price: "\$1,370", perPerson: "\$685 per person", outcome: "Toward IKO Level 3", vikingId: "3700000020000000332a184a", detail: "Zero to riding for both of you. Board starts, upwind, independent.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
  "intermediate-solo": [
    ...
    { name: "Block of 3",     sessions: "3 × 2 hours",         price: "\$645",   outcome: "IKO Level 4 to 5", badge: "Most Popular", featured: true, vikingId: "3700000002000000864d2340", detail: "Goals set before session one. Progress reviewed after each. Real coaching, real results.", photo: photoInstructionWater.src, photoPosition: "object-center" },
    { name: "Block of 5",     sessions: "5 × 2 hours",         price: "\$995", outcome: "IKO Level 5",   vikingId: "3700000007000000b4bdfd77", detail: "Five sessions. Enough to genuinely transform your riding in Bonaire's trade winds.", photo: photoBoatSupport.src, photoPosition: "object-center" },
  ],
  "intermediate-duo": [
